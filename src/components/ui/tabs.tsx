  ...
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-horizontal/tabs:h-8 group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        ...
        custom: "bg-input/30 dark:bg-muted",
        settingsTab: "",
      },
    },
    defaultVariants: {
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-background data-active:text-foreground dark:data-active:border-input dark:data-active:bg-input/30 dark:data-active:text-foreground group-data-[variant=settingsTab]/tabs-list:data-active:bg-primary group-data-[variant=settingsTab]/tabs-list:data-active:text-muted dark:group-data-[variant=settingsTab]/tabs-list:data-active:bg-primary",
