...
const SURFACES = [
  ...
  },
  {
    ...
    lead: "Answers out of your pages, not out of thin air.",
    rest: "It searches the passages and reads the pages before it says a word. Ask for the receipts and every claim turns into a link straight into the document.",
    points: [
      "Ask one document, or everything you have ever uploaded",
      "Reads before it answers, every time — that part has no switch",
      "Citations off by default, one click away when you want them",
